...
Set-Content -LiteralPath (Join-Path $publicReleaseDir "$PublicLabel-RELEASE-NOTES.txt") -Encoding UTF8 -Value @(
    ...
    '- Restores the official release icon set for the installed host, taskbar/window, MSI branding, shortcuts, uninstall entry, and Portable EXE download.',
    ...
    '- Restores the official release icon set across runtime icon, MSI, shortcuts, uninstall assets, and the downloadable Portable EXE.',
