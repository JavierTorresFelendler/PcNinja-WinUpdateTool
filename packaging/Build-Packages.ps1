...
Set-Content -LiteralPath (Join-Path $publicReleaseDir "$PublicLabel-RELEASE-NOTES.txt") -Encoding UTF8 -Value @(
    ...
    '- Uses the new unified PcNinja WinUpdate icon for the Portable EXE download, desktop, Start Menu, taskbar, and uninstall surfaces.',
    ...
    '- Uses the new unified PcNinja WinUpdate icon across the downloadable Portable EXE, desktop, Start Menu, taskbar, and uninstall surfaces.',
